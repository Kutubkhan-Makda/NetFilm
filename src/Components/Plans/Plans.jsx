...
const Plans = () => {
  ...
  const loadCheckout =async(priceId)=>{
    const docRef = await db.collection('costomers').doc(user.uid).collection("checkout_sessions").add({
      price: priceId,
  ...
  return (
    <div className='plans'>
      ...
      {Object.entries(products).map(([productId , productData]) => {
        ...
        return(
          <div key={productId} className={`${isCurrentPackage && "plans_disable"} plans`}>
